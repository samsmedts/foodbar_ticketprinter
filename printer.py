#!/usr/bin/python3
#Software voor de nieuwe bestelsite
...
def printMessagedecoder(messageID):
    ...
    for bestelling in messageSplit_1:
        ...
        bestelInfo = bestelInfo.replace("\\r\\n","")
        bestelInfo = bestelInfo.replace("=","")
        if counter == len(messageSplit_1):
            bestelInfo = bestelInfo[:-1]
        #else:
    ...
    klantBetaalmethode = klantObject["Betaalmethode"]
    ...
    printLine(klantBetaalmethode)
    printLine(legeLijn)
    # Er worden geen levering gedaan waardoor het adres overbodig is.
    ...
    for bestelling in bestellingen:
        ...
        productCatNaam = bestellingObject["ProductCatNaam"]
...
# FIRST WIFI Check -----------------------------------------
#Check eerst of er wifi is voor we verder gaan
def connect(host="https://www.google.com"):
    try:
        urllib.request.urlopen(host)
        print("We have an connection")
        return False
    except:
        print("No connection")
        return True
...
while wifiStatus:
    ...
    if (loopCycli == 10):
        printLine('Geen internet connectie. Bel Sam')
        printLegeLijnen(4)
        
if (loopCycli >= 10):
    printLine('Internet connectie is terug!')
    printLegeLijnen(4)
        
# SETUP GMAIL -----------------------------------------

HOSTNAME = 'imap.gmail.com'
USERNAME = 'foodbarbrechtorder@gmail.com' # foodbarbrechtorder@gmail.com = gaqx xhhe gkxr keix
PASSWORD = 'gaqx xhhe gkxr keix'# App code aangemaakt in Gmail settings __foodbarbrechtbestelling@gmail.com = jwfj vckp qpeq jema
